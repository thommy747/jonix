...
public enum JonixPackages
{
	 ...
	 */
	v21_Reference("org.editeur.onix.v21.references", "http://www.editeur.org/onix/2.1/reference", new org.jonix.mappers.v21.references.ProductMapper(),
			new org.jonix.mappers.v21.references.HeaderMapper()),

	/**
	 * ONIX v2.1 with SHORT tags
	 */
	v21_Short("org.editeur.onix.v21.shorts", "http://www.editeur.org/onix/2.1/short", new org.jonix.mappers.v21.shorts.ProductMapper(),
			new org.jonix.mappers.v21.shorts.HeaderMapper()),
