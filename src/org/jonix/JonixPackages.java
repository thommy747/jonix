...
public enum JonixPackages
{
	 ...
	 */
	v21_Reference("org.editeur.onix.v21.references", "http://www.editeur.org/onix/2.1/reference", new org.jonix.resolve.JonixResolver_v21_reference()),

	/**
	 * ONIX v2.1 with SHORT tags
	 */
	v21_Short("org.editeur.onix.v21.shorts", "http://www.editeur.org/onix/2.1/short", new org.jonix.resolve.JonixResolver_v21_short()),

	/**
	 * ONIX v3.0 with REFERENCE tags - <b>Unsupported yet</b>
	 */
	v30_Reference("org.editeur.onix.v30.references", "http://ns.editeur.org/onix/3.0/reference", new org.jonix.resolve.JonixResolver_v30_reference()),

	/**
	 * ONIX v3.0 with SHORT tags - <b>Unsupported yet</b>
	 */
	v30_Short("org.editeur.onix.v30.shorts", "http://ns.editeur.org/onix/3.0/short", new org.jonix.resolve.JonixResolver_v30_short());
